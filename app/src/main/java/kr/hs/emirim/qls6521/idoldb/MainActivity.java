package kr.hs.emirim.qls6521.idoldb;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        butInit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                db=dbHelper.getWritableDatabase();//변경되거나 쓰려면 writable
                dbHelper.onUpgrade(db,1,2);//변경이가능한db여야하는구나!
                db.close();
            }
        });
        ...
        butInput.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                db.execSQL("insert into idoltable values('"+editName.getText().toString()+"', "+editCount.getText().toString()+")");//변경되면 execSQL
                db.close();
    ...
    class MyDBHelper extends SQLiteOpenHelper{
        public MyDBHelper(Context context){
            super(context,"idoldb",null,1);//이 이름의 sqlite db가 생성
        }

        @Override
        public void onCreate(SQLiteDatabase db) {
            db.execSQL("create table idoltable(gname char(40) primary key, gcount integer);");//table 생성하는 문장
